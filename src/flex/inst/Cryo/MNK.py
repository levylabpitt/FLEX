'''
Levylab FLEX instrument driver for Oxford MNK - OI1820 and Leiden TC (AVS47B)
...
class MNK:
    '''
    Oxford MNK Instrument - unified interface for magnet and temperature control.
    
    This super instrument consists of two subsystems with different network addresses:
    - Magnet controller (Oxford 1820)
    - Temperature controller (Leiden TC (AVS47B))
    '''
    ...
    def __init__(self, 
        ...
        '''
        self._magnet = _MNKMagnet(magnet_address)
        self._temp = _MNKTemp(temp_address)
