...
class KH7008(Instrument):
    ...
    def setKHchannel(self, config:dict):
        cmd = 'setAllChannels'
        params = {'allChannelProperties': config}
        self._send_command(cmd, params)

    def setKHchannelsingle(self, config:dict):
        cmd = 'setChannel'
        params = {'allChannelProperties': config}
        self._send_command(cmd, params)
...
if __name__ == "__main__":
    ...
    #     {"channel":3,"gain":"10","input":"SE-","shunt":"50k","couple":"AC","filter":"ON"},
    #     {"channel":4,"gain":"10","input":"SE-","shunt":"10M","couple":"DC","filter":"ON"},
    #     {"channel":5,"gain":"100","input":"SE+","shunt":"5k","couple":"DC","filter":"ON"},
    #     {"channel":6,"gain":"1000","input":"DIFF","shunt":"5k","couple":"DC","filter":"ON"},
    #     {"channel":7,"gain":"1000","input":"OFF","shunt":"Open","couple":"DC","filter":"ON"},
    #     {"channel":8,"gain":"10","input":"SE-","shunt":"50k","couple":"AC","filter":"ON"}]
    channel_config = [{"channel":1,"gain":"10","input":"DIFF","shunt":"10M","couple":"DC","filter":"OFF"}]
    
    kh.setKHchannelsingle(channel_config)
    kh.close()